...
import type { StorePreferencePayload } from "../../hooks/types/prefrence";
  ...
  return (
    ...
    >
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {isEdit ? "Edit Preferences" : "Set Preferences"}
          </DialogTitle>
          <DialogDescription>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-3">
              {["day", "evening", "night"].map((type) => {
                const isSelected =
                  formData.preferred_shift_types?.includes(type);
                return (
                  <button
                    key={type}
                    type="button"
                  ...
                  >
                    {type === "day" && <Sun className="w-4 h-4" />}
                    {type === "evening" && <Sunset className="w-4 h-4" />}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    max_shifts_per_week: parseInt(e.target.value) || 0,
                  })
                }
              />
            </div>
